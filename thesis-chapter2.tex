...
We developed software for an efficient and scalable InSAR processing chain to ingest geocoded SLC images and output cumulative surface deformation maps (Figure).
