...
The first widely successful InSAR topography mission was the 11-day SRTM by NASA in 2000 (Figure \ref{fig:ch2-sar-missions}). The SRTM produced elevation data with 30-meter resolution for all Earth land surface  from -60$^{\circ} $ to 60$^{\circ} $ latitude. More recently, the TanDEM-X mission by DLR produced a global DEM in 2016 with 12 meter pixels and 2 meter vertical accuracy using two identical satellites flying in formation. However, the TanDEM-X DEM is not publicly available like the SRTM DEM.
