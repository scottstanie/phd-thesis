...
In this chapter, we present a method for robustly extracting slowly-varying surface deformation over long period of time.
...
\section{Sentinel-1 surface deformation over the Permian Basin}

We processed an additional three years of Sentinel-1 data though December, 2021 for Paths 78 and 85 (Figure \ref{fig:paper1-study-area}) following the processing outlined in Section \ref{sec:ch3-insar-processing}. 
...
Additionally, we tested our algorithm on the ascending Path 151 immediately west of Path 85 to obtain full coverage of the Delaware Basin.

\subsection{Path 78 line of sight results}
...
%TODO: plot Bettadpurs gps in figure
...
\begin{figure}
	...
	\caption[GPS comparison for Path 78 LOWESS smoothing]{
		Comparison of Path 78 LOWESS smoothed algorithm (green linens) with permanent GPS stations projected onto the radar LOS (blue dots) along with moving 60-day average (orange line).
	}
	\label{fig:ch5-results-gps}
\end{figure}

% REMINDER: TXM5, TXB8 started
...
\begin{figure}
	...
	\caption[Cumulative 7-year LOS deformation for three Sentinel-1 paths]{
		...
		Purple outlines indicates (from west to east) the Delaware Basin, Central Basin Platform, and Midland Basin.
	}
...
\begin{figure}
	\centering
	\includegraphics[width=.98\textwidth]{figures/chapter5-lowess/figure-results-eqs.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=.98\textwidth]{figures/chapter5-lowess/figure-cmez-zoom.pdf}
	\caption[Culberson-Mentone Earthquake Zone earthquakes during 2020 - 2021]{
		...
		(b) TexNet earthquakes during 2020 - 2021 in the Culberson-Mentone Earthquake Zone (CMEZ) region. Hypocenters shown were relocated using GrowClust \cite{Trugman2017GrowclustHierarchicalClustering}. 
	}
	\label{fig:ch5-discuss-cmez}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=.98\textwidth]{figures/chapter5-lowess/figure-cmez-transects.pdf}
	\caption[2020 - 2021 surface deformation along CMEZ transects ]{
		Vertical surface deformation along (a) blue transect and (b) orange transect from Figure \ref{fig:ch5-discuss-cmez}a  for two-year intervals of 2016-2017 (blue line), 2018-2019 (orange), and 2020-2021 (green). Both transects in panels (a) and (b) run from north to south as distance increases.
	}
	\label{fig:ch5-discuss-transects}
\end{figure}
