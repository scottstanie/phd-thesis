...
\begin{figure}
	...
	\caption[Example results for Path 78 LOWESS smoothing]{
		...
		For comparison, ENU GPS time series stations have been projected onto the radar LOS (blue dots). Orange line shows 30 day moving average of GPS daily measurements.
	}
