...
\begin{figure}
	...
	\caption[Example permanent GPS station measurements]{
		Example measurements of (a) east, (b) north, and (c) vertical components of surface deformation from the permanent GPS station TXMC (Figure \ref{fig:paper1-study-area}).
	}
	\label{fig:ch3-gps}
\end{figure}
