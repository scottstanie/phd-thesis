...
We also analyzed the effectiveness of correction techniques based on auxiliary data (Section \ref{sec:ch2-noise-tropo-mitigate}).
...
Due to the sparsity of GPS stations, the GACOS corrections for West Texas mostly rely on the GAM input.
% GAMs and GPS data . 
