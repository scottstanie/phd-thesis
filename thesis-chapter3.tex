...
\begin{figure}
	...
	\includegraphics[width=1.0\textwidth]{figures/chapter2-sar/figure_tropo_correct_gacos_GRL.pdf}	\caption[GACOS tropospheric correction]{
	...
	\label{fig:ch2-tropo-correct-gacos1}
\end{figure}
