...
\begin{equation}
	\Delta \phi = \frac{4 \pi}{\lambda} \Delta r +  \Delta \phi_{orb} + \Delta \phi_{dem} + \Delta \phi_{decor} + \Delta \phi_{unwrap} + \Delta \phi_{iono} + \Delta \phi_{tropo}  + \Delta \phi_{n}  
...
The hydrostatic delay, caused by dry air pressure and temperature, is on the order of a few meters; however, it varies slowly laterally and it is often assumed to be vertically stratified (i.e. varying only with elevation) for areas smaller than $100 \times 100$ km \citep{Doin2009CorrectionsStratifiedTropospheric}.
