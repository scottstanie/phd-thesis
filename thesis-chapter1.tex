...
The existing studies mainly focused on sites $ \sim $ 60-by-60 $km^2$ or smaller, but basin-wide InSAR surface deformation data with detailed uncertainty quantification are needed for assessing regional induced seismicity risk. One of the challenges for large-scale West Texas InSAR data analysis is the presence of severe tropospheric noise that 


noise arising from changes in water vapor content within the troposphere.
