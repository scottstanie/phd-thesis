...
Here we present details of the geomechanical modeling performed by Hunjoo Lee (\cite{Staniewicz2020InsarRevealsComplex}) using the surface deformation data from Chapter \ref{CHAP:4-GRL}.
