...
Over the past decade, as the Permian Basin became the United States' largest producer of oil and gas, the region experienced a sharp rise in the number of earthquakes.  While subsurface measurements are expensive and difficult to obtain, Interferometric Synthetic Aperture Radar (InSAR) is a remote sensing technique which can measure deformation of Earth's surface over broad areas with 10-100 meter spatial resolution and millimeter-to-centimeter accuracy. These measurements can be used to derive information about Earth’s subsurface, estimate the distribution of fault slip, and infer associated seismic risk.
However, the noise sources of InSAR pose considerable challenges to achieving millimeter-level accuracy over large study areas, and automated and scalable algorithms are necessary to process and interpret the ever-growing volume of InSAR data.  Here we demonstrate the ability to measure subtle surface deformation features caused by petroleum production and induced earthquakes over the entire Permian Basin.
A rigorous analysis of all noise sources in the Permian Basin Sentinel-1 InSAR data identified tropospheric turbulence noise as the dominant noise term, and we developed methods for characterizing the tropospheric noise and its power spectral density directly from InSAR data. We designed scalable time series algorithms which are robust to troposphere noise outliers for reconstructing the temporal evolution of surface deformation over very wide regions. Based on independent validation from GPS permanent stations, our cumulative surface deformation solutions from 2014 - 2021 achieved millimeter-level accuracy.
